      ...
      <main className="flex-grow container mx-auto px-8 py-24 max-w-[1200px]">
        ...
        <div className="prose prose-invert max-w-3xl mx-auto text-gray-300">
          ...
          <ul>
            ...
            <li>
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Devan Yudistira Sugiharta.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to Devan Yudistira Sugiharta's Portfolio, accessible from <a href="https://devansugiharta.my.id" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:underline">devansugiharta.my.id</a>
            </li>
            <li>
          ...
          <p>
            Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <a href="https://www.privacypolicies.com/blog/cookies/" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:underline">Privacy Policies website</a> article.
          </p>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Use of Your Personal Data</h2>
          ...
          <ul>
            ...
            <li>
              <strong>For business transfers:</strong> We may use Your information to evaluate or conduct a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
            </li>
            <li>
          ...
          <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Disclosure of Your Personal Data</h2>
          ...
          <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Security of Your Personal Data</h2>
          <p>
            The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.
          </p>
          <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Links to Other Websites</h2>
          <p>
          ...
          <ul>
            <li>By email: masdevansugiharta@gmail.com</li>
          </ul>
        </div>
      </main>
      <Footer />
