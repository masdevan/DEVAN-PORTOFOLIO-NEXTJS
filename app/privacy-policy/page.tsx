      ...
      <main className="flex-grow container mx-auto px-8 py-24 max-w-[1200px]">
        ...
        <div className="prose prose-invert max-w-3xl mx-auto text-gray-300">
          ...
          <ul>
            ...
            <li>
              <strong>Website</strong> refers to Devan Yudistira Sugiharta's Portfolio, accessible from <a href="https://devansugiharta.my.id" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:underline">devansugiharta.my.id</a>
            </li>
            <li>
          ...
          <p>
            Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <a href="https://www.privacypolicies.com/blog/cookies/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:underline">Privacy Policies website</a> article.
          </p>
          <p>
